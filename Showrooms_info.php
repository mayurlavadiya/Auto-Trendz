...
?>
 ...
 $q="select * from showroom_master where Shr_city='$City_id' and SubCat_id=$sub_id";
 $c=mysql_query($q);
		...
		<section class="holder clearfix"> 
			  ...
			  <?php while($r=mysql_fetch_array($c)){ ?>
                  <tr align="left" class="active">
                    <td class="active"><strong><?php echo $r['Shr_name']; ?></strong></td>
                    <td class="active"><strong><?php echo $r['Shr_address']; ?></strong></td>
                    <td class="active"><strong><?php echo $r['Shr_city']; ?></strong></td>
                    <td class="active"><strong><?php echo $r['Shr_c_no']; ?></strong></td>
                    <td class="active"><strong><img height="50" width="50" src="admin/img/car/<?php echo $r['Shr_img']; ?>"/></strong></td>
                  </tr><?php } ?>
                </table>
