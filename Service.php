...
?>
	...
	<section class="container">	
		...
		<section class="holder clearfix bordered">
            <div class="two-third column"><img src="admin/img/car/Auto-Repair.jpg" width="310"/></div>
                        
            <div class="one-third column">
             <div class="bordered">
            	
                    <form action="Service_info.php" method="post">
                    <h2><strong>Search Service</strong></h2>
                    <label>Search Service at AutoTrendz</label><br/></br>
                   <?php 
